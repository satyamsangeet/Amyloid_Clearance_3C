...
model_points_global6 = interp1(x, cdata_36hours1_global6, time_exp1);
...
scatter(time_exp1, model_points_global6, 80, colormap_jet(6,:), 'filled', 'MarkerEdgeColor', 'k', 'HandleVisibility','off');
