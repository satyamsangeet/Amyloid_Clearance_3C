...
function [total_error] = objective_function_fmincon(params, exp_csf1)
    ...
    fprintf('Parameters: r_bc=%.5f, r_bp=%.4f, r_cp=%.5f\n', ...
...
num_starts = 20;
initial_guess = [3, 0.2, 0.004];
lb = [2.4320, 0.1, 0.0001];
ub = [5, 5, 0.00533];
...
for i = 1:num_starts
    ...
    % Log the results
    fprintf('\nRun %d:\n', i);
    fprintf('Parameters: r_bc=%.5f, r_bp=%.5f, r_cp=%.5f\n', ...
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: r_bc=%.5f, r_bp=%.4f, r_cp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3));
...
% Write best solution
fprintf(fileID, '\nBest Solution:\n');
fprintf(fileID, 'Parameters: r_bc=%.5f, r_bp=%.5f, r_cp=%.5f\n', ...
