...
data_model4_comp1 = sol_100days_global4(233600:237200, 1); % Compartment 1, model 2
data_model4_comp2 = sol_100days_global4(233600:237200, 2); % Compartment 2, model 2
data_model4_comp3 = sol_100days_global4(233600:237200, 3); % Compartment 3, model 2
...
model3_table = table(t_extraction, data_model3_comp1, data_model3_comp2, data_model3_comp3, ...
                    'VariableNames', {'Time', 'Compartment_1', 'Compartment_2', 'Compartment_3'});
model4_table = table(t_extraction, data_model4_comp1, data_model4_comp2, data_model4_comp3, ...
                    'VariableNames', {'Time', 'Compartment_1', 'Compartment_2', 'Compartment_3'});

% Write tables to CSV files
writetable(model1_table, 'global_model1.csv');
writetable(model2_table, 'global_model2.csv');
writetable(model3_table, 'global_error1.csv');
writetable(model4_table, 'global_error2.csv');
...
cdata_36hours4_global4 = sol_100days_global4(233600:237200, 2);
pdata_36hours4_global4 = sol_100days_global4(233600:237200, 3);
...
csf_36hr_model_global4 = cdata_36hours4_global4(time_indices);
...
plasma_36hr_model_global4 = pdata_36hours4_global4(time_indices);
...
wrmse1_global5 = calculate_wrmse(csf_36hr_model_global1, exp_csf2);
wrmse1_global6 = calculate_wrmse(csf_36hr_model_global2, exp_csf2);
wrmse1_global7 = calculate_wrmse(csf_36hr_model_global3, exp_csf2);
wrmse1_global8 = calculate_wrmse(csf_36hr_model_global4, exp_csf2);
wrmse1_global9 = calculate_wrmse(csf_36hr_model_global1, exp_csf3);
wrmse1_global10 = calculate_wrmse(csf_36hr_model_global2, exp_csf3);
wrmse1_global11 = calculate_wrmse(csf_36hr_model_global3, exp_csf3);
wrmse1_global12 = calculate_wrmse(csf_36hr_model_global4, exp_csf3);
wrmse1_global13 = calculate_wrmse(plasma_36hr_model_global1, exp_plasma1);
wrmse1_global14 = calculate_wrmse(plasma_36hr_model_global2, exp_plasma1);
wrmse1_global15 = calculate_wrmse(plasma_36hr_model_global3, exp_plasma1);
wrmse1_global16 = calculate_wrmse(plasma_36hr_model_global4, exp_plasma1);
...
hold on;
plot(x, cdata_36hours1_global1, 'LineWidth', 2.0, 'Color', colormap_jet(1,:), 'DisplayName', sprintf('Global1 (NRMSE: %.3f)', wrmse1_global1));
plot(x, cdata_36hours2_global2, 'LineWidth', 2.0, 'Color', colormap_jet(2,:), 'DisplayName', sprintf('Global2 (NRMSE: %.3f)', wrmse1_global2));
plot(x, cdata_36hours3_global3, 'LineWidth', 2.0, 'Color', colormap_jet(3,:), 'DisplayName', sprintf('Error 1 (NRMSE: %.3f)', wrmse1_global3));
plot(x, cdata_36hours4_global4, 'LineWidth', 2.0, 'Color', colormap_jet(4,:), 'DisplayName', sprintf('Error 2 (NRMSE: %.3f)', wrmse1_global4));
...
model_points_global14 = interp1(x, cdata_36hours4_global4, time_exp1);
...
scatter(time_exp1, model_points_global14, 80, colormap_jet(4,:), 'filled', 'MarkerEdgeColor', 'k', 'DisplayName', 'Global Fit Points');
...
fill(x1, inBetween1, [0.7 0.7 0.7], 'FaceAlpha', 0.3, 'EdgeColor', 'k', 'HandleVisibility', 'off');
hold on;
plot(x, cdata_36hours1_global1, 'LineWidth', 2.0, 'Color', colormap_jet(1,:), 'DisplayName', sprintf('Global1 (NRMSE: %.3f)', wrmse1_global5));
plot(x, cdata_36hours2_global2, 'LineWidth', 2.0, 'Color', colormap_jet(2,:), 'DisplayName', sprintf('Global2 (NRMSE: %.3f)', wrmse1_global6));
plot(x, cdata_36hours3_global3, 'LineWidth', 2.0, 'Color', colormap_jet(3,:), 'DisplayName', sprintf('Error 1 (NRMSE: %.3f)', wrmse1_global7));
plot(x, cdata_36hours4_global4, 'LineWidth', 2.0, 'Color', colormap_jet(4,:), 'DisplayName', sprintf('Error 2 (NRMSE: %.3f)', wrmse1_global8));
...
model_points_global24 = interp1(x, cdata_36hours4_global4, time_exp2);
...
scatter(time_exp2, model_points_global24, 80, colormap_jet(4,:), 'filled', 'MarkerEdgeColor', 'k', 'DisplayName', 'Global Fit Points');
xline(1600, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xline(2400, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xlim([2336, 2386]);
xticks(0:200:4000);
...
fill(x1, inBetween1, [0.7 0.7 0.7], 'FaceAlpha', 0.3, 'EdgeColor', 'k', 'HandleVisibility', 'off');
hold on;
plot(x, cdata_36hours1_global1, 'LineWidth', 2.0, 'Color', colormap_jet(1,:), 'DisplayName', sprintf('Global1 (NRMSE: %.3f)', wrmse1_global9));
plot(x, cdata_36hours2_global2, 'LineWidth', 2.0, 'Color', colormap_jet(2,:), 'DisplayName', sprintf('Global2 (NRMSE: %.3f)', wrmse1_global10));
plot(x, cdata_36hours3_global3, 'LineWidth', 2.0, 'Color', colormap_jet(3,:), 'DisplayName', sprintf('Error 1 (NRMSE: %.3f)', wrmse1_global11));
plot(x, cdata_36hours4_global4, 'LineWidth', 2.0, 'Color', colormap_jet(4,:), 'DisplayName', sprintf('Error 2 (NRMSE: %.3f)', wrmse1_global12));
...
model_points_global34 = interp1(x, cdata_36hours4_global4, time_exp3/10);
...
scatter(time_exp3/10, model_points_global34, 80, colormap_jet(4,:), 'filled', 'MarkerEdgeColor', 'k', 'DisplayName', 'Global Fit Points');
xline(1600, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xline(2400, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xlim([2336, 2386]);
xticks(0:200:4000);
...
fill(x1, inBetween1, [0.7 0.7 0.7], 'FaceAlpha', 0.3, 'EdgeColor', 'k', 'HandleVisibility', 'off');
hold on;
plot(x, pdata_36hours1_global1, 'LineWidth', 2.0, 'Color', colormap_jet(1,:), 'DisplayName', sprintf('Global1 (NRMSE: %.3f)', wrmse1_global13));
plot(x, pdata_36hours2_global2, 'LineWidth', 2.0, 'Color', colormap_jet(2,:), 'DisplayName', sprintf('Global2 (NRMSE: %.3f)', wrmse1_global14));
plot(x, pdata_36hours3_global3, 'LineWidth', 2.0, 'Color', colormap_jet(3,:), 'DisplayName', sprintf('Error 1 (NRMSE: %.3f)', wrmse1_global15));
plot(x, pdata_36hours4_global4, 'LineWidth', 2.0, 'Color', colormap_jet(4,:), 'DisplayName', sprintf('Error 2 (NRMSE: %.3f)', wrmse1_global16));
...
model_points_global44 = interp1(x, pdata_36hours4_global4, time_exp3/10);
...
scatter(time_exp3/10, model_points_global44, 80, colormap_jet(4,:), 'filled', 'MarkerEdgeColor', 'k', 'DisplayName', 'Global Fit Points');
xline(1600, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xline(2400, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xlim([2336, 2386]);
xticks(0:200:4000);
