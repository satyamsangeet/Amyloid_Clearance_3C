...
function [total_error] = objective_function_fmincon(params, exp_csf1, exp_csf2, exp_csf3, exp_plasma)
    ...
    fprintf('Parameters: r_bc=%.5f, r_cp=%.5f, sigma_bc=%.5f, sigma_cp=%.5f, sigma_A=%.5f, sigma_bp=%.5f, sigma_p=%.5f\n', ...
...
function plot_parameter_space(solutions, num_starts)
    ...
    param_names = {'r_bc', 'r_cp', 'sigma_bc', 'sigma_cp', 'sigma_A', 'sigma_bp', 'sigma_p'};
...
num_starts = 20;
initial_guess = [2.5, 0.004, 0.8, 2.5, 0.8, 6.607, 4.028];
lb = [1.319, 0.0001, 0.1, 0.1, 0.731, 0.1, 0.1];
ub = [5, 0.00545, 1.185, 4.173, 0.9, 7, 7];
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: r_bc=%.5f, r_cp=%.5f, sigma_bc=%.5f, sigma_cp=%.5f, sigma_A=%.5f, sigma_bp=%.5f, sigma_p=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4), solutions(i).params(5), solutions(i).params(6), solutions(i).params(7));
