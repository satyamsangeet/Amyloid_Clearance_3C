...
function dydt_n = model(t, y, params)
    A = 13.376905249820030;
    sigma_A = 0.706320661906573;
    r_bp = 0.188222568300386;
    sigma_bp = 3.429852956480516;
    r_p = 0.286926453077923;
    sigma_p = 2.159348857063976;
    r_bc = 2.432013905614033;
    r_cp = 0.005338378999426;
    ...
    if(t>=2352 && t<2372)
        ...
        sigma_bc = 2.153368715140215;
        sigma_cp = 6.450249824200903;
    end
...
function [total_error] = objective_function_fmincon(params, exp_csf1)
    ...
    fprintf('Parameters: sigma_bc=%.5f, sigma_cp=%.5f\n', ...
            params(1), params(2));
...
function plot_parameter_space(solutions, num_starts)
    ...
    saveas(gcf, 'lucey_exp_fit_7th_hypothesis/parameter_space.png');
    print('lucey_exp_fit_7th_hypothesis/parameter_space_highres', '-dpng', '-r300');

    % NEW CODE: Save parameter space data to CSV files
    for param_idx = 1:2
        % Create and open CSV file for this parameter
        param_name = param_names{param_idx};
        csv_filename = sprintf('lucey_exp_fit_7th_hypothesis/parameter_space_%s.csv', param_name);
...
if ~exist('lucey_exp_fit_7th_hypothesis', 'dir')
    mkdir('lucey_exp_fit_7th_hypothesis');
end
...
for i = 1:num_starts
    ...
    save(sprintf('lucey_exp_fit_7th_hypothesis/run_%d_results.mat', i), ...
        'run_results');
...
fileID_corr = fopen('lucey_exp_fit_7th_hypothesis/correlation_matrix.txt', 'w');
...
saveas(gcf, 'lucey_exp_fit_7th_hypothesis/correlation_heatmap.png');
...
save('lucey_exp_fit_7th_hypothesis/final_results.mat', 'final_results');

% Create a text file to save results
fileID = fopen('lucey_exp_fit_7th_hypothesis/detailed_results.txt', 'w');
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: sigma_bc=%.5f, sigma_cp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2));
...
for i = 1:num_starts
    ...
    writematrix(loss_data, sprintf('lucey_exp_fit_7th_hypothesis/loss_curve_run_%d.csv', i));
end
...
legend;
hold off;
saveas(gcf, 'lucey_exp_fit_7th_hypothesis/loss_curves.png');
