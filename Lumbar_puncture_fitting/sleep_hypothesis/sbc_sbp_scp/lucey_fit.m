...
function [total_error] = objective_function_fmincon(params, exp_csf1)
    ...
    fprintf('Parameters: s_bc=%.5f, s_cp=%.4f, s_bp=%.5f\n', ...
...
num_starts = 20;
initial_guess = [1.5, 4, 1.5];
lb = [0.01, 0.01, 0.01];
ub = [2.153, 6.450, 3.429];
...
for i = 1:num_starts
    ...
    % Log the results
    fprintf('\nRun %d:\n', i);
    fprintf('Parameters: s_bc=%.5f, s_cp=%.5f, s_bp=%.5f\n', ...
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: s_bc=%.5f, s_cp=%.4f, s_bp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3));
...
% Write best solution
fprintf(fileID, '\nBest Solution:\n');
fprintf(fileID, 'Parameters: s_bc=%.5f, s_cp=%.5f, s_bp=%.5f\n', ...
