...
function [total_error] = objective_function_fmincon(params, exp_csf1)
    ...
    fprintf('Parameters: s_A=%.5f, s_bc=%.5f, s_bp=%.5f, s_cp=%.5f\n', ...
...
function plot_parameter_space(solutions, num_starts)
    ...
    param_names = {'s_A', 's_bc', 's_bp', 's_cp'};
...
num_starts = 20;
initial_guess = [0.8, 1.5, 2, 5];
lb = [0.706, 0.1, 0.1, 0.1];
ub = [0.9, 2.153, 3.429, 6.450];
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: s_A=%.5f, s_bc=%.5f, s_bp=%.5f, s_cp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4));
