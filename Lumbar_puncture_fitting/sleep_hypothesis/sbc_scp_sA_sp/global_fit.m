...
function [total_error] = objective_function_fmincon(params, exp_csf1, exp_csf2, exp_csf3, exp_plasma)
    ...
    fprintf('Parameters: s_bc=%.5f, s_cp=%.5f, s_p=%.5f, s_A=%.5f\n', ...
...
num_starts = 20;
initial_guess = [0.8, 2.5, 1.5, 0.8];
lb = [0.01, 0.01, 0.01, 0.731];
ub = [1.185, 4.173, 4.028, 0.9];
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: s_bc=%.5f, s_cp=%.5f, s_p=%.5f, s_A=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4));
