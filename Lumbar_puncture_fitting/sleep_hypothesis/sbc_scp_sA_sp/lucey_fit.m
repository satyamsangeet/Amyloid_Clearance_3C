...
function [total_error] = objective_function_fmincon(params, exp_csf1)
    ...
    fprintf('Parameters: s_p=%.5f, s_bc=%.5f, s_A=%.5f, s_cp=%.5f\n', ...
...
num_starts = 20;
initial_guess = [1.5, 1.5, 0.8, 5];
lb = [0.01, 0.1, 0.706, 0.1];
ub = [2.159, 2.153, 0.9, 6.450];
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: s_p=%.5f, s_bc=%.5f, s_A=%.5f, s_cp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4));
