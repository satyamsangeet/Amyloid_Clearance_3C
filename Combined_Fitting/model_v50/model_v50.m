...
learning_rate = 0.001;
num_iterations = 5000; % Set the correct number of iterations

for iter = 1:num_iterations
    [current_error, is_valid] = objective_function(params, exp_csf, exp_plasma, csf_std, plasma_std);
    ...
    for i = 1:length(params)
        ...
        [new_error, is_valid_temp] = objective_function(params_temp, exp_csf, exp_plasma, csf_std, plasma_std);
        if is_valid_temp
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/optimized_params_model_v50_clearance.csv', 'w');
fprintf(fileID, '%.15f,%.15f,%.15f,%.15f,%.15f,%.15f\n', optimized_params);
fclose(fileID);

% Save the loss values
lossID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v50_loss_clearance.csv', 'w');
if lossID == -1
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v50_output_clearance.csv', 'w');
...
optimized_params = readmatrix('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/optimized_params_model_v50_clearance.csv');
...
saved_data = readmatrix('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v50_output_clearance.csv');
