...
model_csf_blattner = interp1(x, cdata_36hours1_global2, time_exp1_adjusted);
...
% Plot
figure();
stem(time_hours_plot, residuals_blattner, 'filled', ...
...
text(1, max(abs(residuals_blattner))*0.85, ...
    sprintf('Mean = %.2f pg/ml', mean(residuals_blattner)), 'FontSize', 9)
grid on
hold off
