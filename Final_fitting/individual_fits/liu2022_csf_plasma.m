...
function [param_means, param_stds, param_ci] = bootstrap_parameters(csf_conc_exp3, plasma_conc_exp1, csf_std3, plasma_std1, num_bootstraps, confidence_level)
    n = length(csf_conc_exp3);
    ...
    for i = 1:num_bootstraps
        ...
        [bootstrap_params(i,:), ~] = fmincon(@(params) objective_function_fmincon(params, bootstrap_csf3, bootstrap_plasma1, bootstrap_csf_std3, bootstrap_plasma_std1), ...
...
function [total_error] = objective_function_fmincon(params, exp_csf3, exp_plasma1, csf_std3, plasma_std1)
...
options = optimoptions('fmincon', 'Display', 'iter', 'MaxIterations', 2000, 'MaxFunctionEvaluations', 10000, 'OutputFcn', @save_loss_values);

problem = createOptimProblem('fmincon', ...
    'objective', @(params) objective_function_fmincon(params, csf_conc_exp3, plasma_conc_exp1, csf_std3, plasma_std1), ...
    'x0', initial_guess, ...
    'lb', lb, ...
    'ub', ub, ...
    'options', options);
...
[param_means, param_stds, param_ci] = bootstrap_parameters(csf_conc_exp3, plasma_conc_exp1, csf_std3, plasma_std1, num_bootstraps, confidence_level);
...
plot(time_exp, csf3_conc_exp, 'g--', 'LineWidth', 2.0, 'DisplayName', 'Blattner2020 - CSF');
