...
% bootstrapping
function [param_means, param_stds, param_ci] = bootstrap_parameters(csf_conc_exp1, csf_std1, num_bootstraps, confidence_level)
    ...
    for i = 1:num_bootstraps
        ...
        [bootstrap_params(i,:), ~] = fmincon(@(params) objective_function_fmincon(params, bootstrap_csf1, bootstrap_csf_std1), ...
...
[param_means, param_stds, param_ci] = bootstrap_parameters(csf_conc_exp1, csf_std1, num_bootstraps, confidence_level);
...
% Running model with optimised params
