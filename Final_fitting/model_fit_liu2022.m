...
function [total_error] = objective_function(params, exp_csf, exp_plasma, csf_std, plasma_std)
    global loss_values;
...
initial_guess = [1.5, 1.5, 1.5, 21, 0.3, 0.02];

% Define bounds for parameters
lb = [1, 1, 1, 20, 0.1, 0.01];
ub = [3, 3, 3, 24, 1, 0.1];
...
function [total_error] = fmincon_objective(params, exp_csf, exp_plasma, csf_std, plasma_std)
    total_error = objective_function(params, exp_csf, exp_plasma, csf_std, plasma_std);
end
...
errorbar(time_exp, csf_conc_exp, csf_conc_exp - csf_lsd, csf_usd - csf_conc_exp, 'g--', 'LineWidth', 2.0, 'HandleVisibility', 'off');
...
errorbar(time_exp, plasma_conc_exp, plasma_conc_exp - plasma_lsd, plasma_usd - plasma_conc_exp, 'g--', 'LineWidth', 2.0, 'HandleVisibility', 'off');
