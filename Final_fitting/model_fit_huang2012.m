...
initial_guess = [2, 5, 5, 21, 0.3, 0.02];

% Define bounds for parameters
lb = [1, 4, 4, 20, 0.1, 0.01];
ub = [3, 10, 10, 24, 1, 0.1];

% Define the objective function for fmincon
function [total_error] = fmincon_objective(params, exp_csf, exp_plasma)
    total_error = objective_function(params, exp_csf, exp_plasma);
end

% Set up optimization options
options = optimoptions('fmincon', 'Display', 'iter', 'MaxIterations', 3000, 'MaxFunctionEvaluations', 10000);

% Run optimization
[optimized_params, fval] = fmincon(@(params) fmincon_objective(params, exp_csf, exp_plasma), ...
                                   initial_guess, [], [], [], [], lb, ub, [], options);

% Save optimized parameters using high precision
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/optimized_params_model_v52_clearance.csv', 'w');
fprintf(fileID, '%.15f,%.15f,%.15f,%.15f,%.15f,%.15f\n', optimized_params);
fclose(fileID);

% Save the loss values
lossID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v52_loss_clearance.csv', 'w');
if lossID == -1
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v52_output_clearance.csv', 'w');
...
optimized_params = readmatrix('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/optimized_params_model_v52_clearance.csv');
...
saved_data = readmatrix('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v52_output_clearance.csv');
