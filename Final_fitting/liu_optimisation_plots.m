...
pdata_12hours1 = sol_100days_gwrmse(233600:234800, 3);
pdata_12hours2 = sol_100days_grmse(233600:234800, 3);
pdata_12hours3 = sol_100days_iwrmse(233600:234800, 3);
pdata_12hours4 = sol_100days_irmse(233600:234800, 3);
...
pdata_36hours1 = sol_100days_gwrmse(233600:237200, 3);
pdata_36hours2 = sol_100days_grmse(233600:237200, 3);
pdata_36hours3 = sol_100days_iwrmse(233600:237200, 3);
pdata_36hours4 = sol_100days_irmse(233600:237200, 3);
csf_mean1 = mean(cdata_12hours1);
csf_mean2 = mean(cdata_12hours2);
csf_mean3 = mean(cdata_12hours3);
csf_mean4 = mean(cdata_12hours4);
plasma_mean1 = mean(pdata_12hours1);
plasma_mean2 = mean(pdata_12hours2);
plasma_mean3 = mean(pdata_12hours3);
plasma_mean4 = mean(pdata_12hours4);
...
normalise_P1 = (pdata_36hours1 / plasma_mean1)*100;
normalise_P2 = (pdata_36hours2 / plasma_mean2)*100;
normalise_P3 = (pdata_36hours3 / plasma_mean3)*100;
normalise_P4 = (pdata_36hours4 / plasma_mean4)*100;

experimental_csf = readtable('/home/satyam/Documents/combined_fitting_data/final_fitting/liu2022_csf42.csv');
experimental_plasma = readtable('/home/satyam/Documents/combined_fitting_data/final_fitting/liu2022_plasma42.csv');
experimental_csf.Time = experimental_csf.Time;
experimental_plasma.Time = experimental_plasma.Time;
...
lsd_plasma = experimental_plasma.LSD;
usd_plasma = experimental_plasma.USD;
...
% Plot comparison CSF
figure();
x2 = [time_exp/10; flipud(time_exp/10)];
...
plot(time_exp/10, csf_conc_exp, 'k--', 'LineWidth', 2.0, 'DisplayName', 'Liu2022 - CSF');
scatter(time_exp/10, csf_conc_exp, 'ko', 'MarkerFaceColor','k', 'HandleVisibility', 'off');
...
figure;
x3 = [time_exp/10; flipud(time_exp/10)];
inBetween2 = [lsd_plasma; flipud(usd_plasma)];
fill(x3, inBetween2, [0.7 0.7 0.7], 'FaceAlpha', 0.3, 'EdgeColor', 'k', 'HandleVisibility', 'off');
hold on;
plot(x, normalise_P1, 'r--', 'LineWidth', 2.0, 'DisplayName', 'Global WRMSE');
plot(x, normalise_P2, 'g--', 'LineWidth', 2.0, 'DisplayName', 'Global RMSE');
plot(x, normalise_P3, 'b--', 'LineWidth', 2.0, 'DisplayName', 'Ind WRMSE');
plot(x, normalise_P4, 'm--', 'LineWidth', 2.0, 'DisplayName', 'Ind RMSE');
plot(time_exp/10, plasma_conc_exp, 'k--', 'LineWidth', 2.0, 'DisplayName', 'Liu2022 - Plasma');
scatter(time_exp/10, plasma_conc_exp, 'ko', 'MarkerFaceColor','k', 'HandleVisibility', 'off');
xline(1600, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xline(2400, 'k--', 'LineWidth', 1.0, 'Alpha', 0.3, 'HandleVisibility', 'off');
xlim([2336, 2386]);
xticks(0:200:3600);
...
legend('show');
xlabel('Time (hr)', 'FontWeight', 'bold');
ylabel('Percetage Baseline Plasma', 'FontWeight', 'bold');
xlim([0, 3500]);
hold off;