...
function [total_error] = objective_function_fmincon(params, exp_csf1)
    ...
    fprintf('Parameters: r_bc=%.5f, r_cp=%.5f, s_A=%.5f, s_bc=%.5f, s_bp=%.5f, s_cp=%.5f, s_p=%.5f\n', ...
...
function plot_parameter_space(solutions, num_starts)
    ...
    param_names = {'r_bc', 'r_cp', 's_A', 's_bc', 's_bp', 's_cp', 's_p'};
...
num_starts = 20;
initial_guess = [3, 0.003, 0.8, 1.5, 2, 5, 1.5];
lb = [2.432, 0.001, 0.706, 0.1, 0.1, 0.1, 0.1];
ub = [5, 0.00532, 0.9, 2.153, 3.429, 6.450, 2.159];
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: r_bc=%.5f, r_cp=%.5f, s_A=%.5f, s_bc=%.5f, s_bp=%.5f, s_cp=%.5f, s_p=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4), solutions(i).params(5), solutions(i).params(6), solutions(i).params(7));
