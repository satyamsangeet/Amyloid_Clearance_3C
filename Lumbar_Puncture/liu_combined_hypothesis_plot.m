...
wrmse1_global5 = calculate_wrmse(plasma_36hr_model_global2, exp_plasma1);
wrmse1_global6 = calculate_wrmse(plasma_36hr_model_global3, exp_plasma1);
...
hold on;
plot(x, cdata_36hours1_global1, 'LineWidth', 2.0, 'Color', colormap_jet(1,:), 'DisplayName', sprintf('B (NRMSE: %.3f)', wrmse1_global1));
plot(x, cdata_36hours1_global2, 'LineWidth', 2.0, 'Color', colormap_jet(2,:), 'DisplayName', sprintf('Lu (NRMSE: %.3f)', wrmse1_global2));
plot(x, cdata_36hours1_global3, 'LineWidth', 2.0, 'Color', colormap_jet(3,:), 'DisplayName', sprintf('Li (NRMSE: %.3f)', wrmse1_global3));
...
fill(x1, inBetween1, [0.7 0.7 0.7], 'FaceAlpha', 0.3, 'EdgeColor', 'k', 'HandleVisibility', 'off');
hold on;
plot(x, pdata_36hours1_global1, 'LineWidth', 2.0, 'Color', colormap_jet(1,:), 'DisplayName', sprintf('B (NRMSE: %.3f)', wrmse1_global4));
plot(x, pdata_36hours1_global2, 'LineWidth', 2.0, 'Color', colormap_jet(2,:), 'DisplayName', sprintf('Lu (NRMSE: %.3f)', wrmse1_global5));
plot(x, pdata_36hours1_global3, 'LineWidth', 2.0, 'Color', colormap_jet(3,:), 'DisplayName', sprintf('Li (NRMSE: %.3f)', wrmse1_global6));
