...
function [total_error] = objective_function_fmincon(params, exp_csf3, exp_plasma1, fitting_error0)
    ...
    if nargin < 4 || isempty(fitting_error0)
    ...
    fprintf('Individual Study Errors: CSF3=%.5f, Plasma1=%.5f\n', ...
            error_C3, error_P1);
...
num_starts = 20;
lb = [0.75, 0, 0, 0, 0];
ub = [0.99, 1.11, 1.297, 6.552, 3.055];
initial_guess = 0.5 * (lb + ub);

fitting_error0 = objective_function_fmincon(initial_guess, csf_conc_exp3, plasma_conc_exp1);
