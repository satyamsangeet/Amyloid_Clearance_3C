...
function [total_error] = objective_function_fmincon(params, exp_csf1, exp_csf2, exp_csf3, exp_plasma1, fitting_error0)
    ...
    fprintf('Parameters: s_bp=%.5f, s_A=%.5f\n', ...
            params(1), params(2));
...
for i = 1:num_starts
    ...
    r_bp = 0.014;
    sigma_bc = 1.131;
    sigma_bp = solutions(i).params(1);
    A = 16.203;
    sigma_A = solutions(i).params(2);
...
% Write best solution
fprintf(fileID, '\nBest Solution:\n');
fprintf(fileID, 'Parameters: s_bp=%.5f, s_A=%.5f\n', ...
