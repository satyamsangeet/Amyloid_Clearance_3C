...
function [total_error] = objective_function_fmincon(params, exp_csf1, exp_csf2, exp_csf3, exp_plasma1, fitting_error0)
    ...
    fprintf('Parameters: r_bc=%.5f, r_cp=%.5f, sigma_A=%.5f, sigma_bc=%.5f, sigma_bp=%.5f, sigma_cp=%.5f, sigma_p=%.5f\n', ...
...
function plot_parameter_space(solutions, num_starts)
    ...
    params_matrix = zeros(num_starts, 7);
    ...
    param_names = {'r_bc', 'r_bp', 'sigma_A', 'sigma_bc', 'sigma_bp', 'sigma_cp', 'sigma_p'};
...
num_starts = 20;
lb = [0.038, 0, 0.772, 0, 0, 0, 0];
ub = [5, 0.00537, 0.99, 1.131, 1.768, 6.1, 4.253];
...
param_names = {'r_bc', 'r_cp', 'sigma_A', 'sigma_bc', 'sigma_bp', 'sigma_cp', 'sigma_p'};
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: r_bc=%.5f, r_cp=%.5f, sigma_A=%.5f, sigma_bc=%.5f, sigma_bp=%.5f, sigma_cp=%.5f, sigma_p=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4), solutions(i).params(5), solutions(i).params(6), solutions(i).params(7));
