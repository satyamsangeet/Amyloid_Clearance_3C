...
function [total_error] = objective_function_fmincon(params, exp_csf1, exp_csf2, exp_csf3, exp_plasma1, fitting_error0)
    ...
    fprintf('Parameters: r_cp=%.5f, sigma_bc=%.5f, sigma_cp=%.5f\n', ...
...
function plot_parameter_space(solutions, num_starts)
    ...
    param_names = {'r_cp', 'sigma_bc', 'sigma_cp'};
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: r_cp=%.5f, sigma_bc=%.5f, sigma_cp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3));
