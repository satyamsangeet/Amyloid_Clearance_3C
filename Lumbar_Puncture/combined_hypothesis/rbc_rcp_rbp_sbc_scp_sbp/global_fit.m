...
function [total_error] = objective_function_fmincon(params, exp_csf1, exp_csf2, exp_csf3, exp_plasma1, fitting_error0)
    ...
    fprintf('Parameters: r_bc=%.5f, r_cp=%.5f, r_bp=%.5f, sigma_bc=%.5f, sigma_cp=%.5f, sigma_bp=%.5f\n', ...
...
function plot_parameter_space(solutions, num_starts)
    ...
    params_matrix = zeros(num_starts, 6);
    ...
    param_names = {'r_bc', 'r_cp', 'r_bp', 'sigma_bc', 'sigma_cp', 'sigma_bp'};
...
num_starts = 20;
lb = [0.038, 0, 0, 0, 0, 0];
ub = [5, 0.00537, 0.25, 1.131, 6.1, 1.768];
...
for i = 1:num_starts
    ...
    fprintf('\nRun %d:\n', i);
    fprintf('Parameters: r_bc=%.5f, r_cp=%.5f, r_bp=%.5f, sigma_bc=%.5f, sigma_cp=%.5f, sigma_bp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4), solutions(i).params(5), solutions(i).params(6));
...
for i = 1:num_starts
    ...
    fprintf(fileID, 'Parameters: r_bc=%.5f, r_cp=%.5f, r_bp=%.5f, sigma_bc=%.5f, sigma_cp=%.5f, sigma_bp=%.5f\n', ...
        solutions(i).params(1), solutions(i).params(2), solutions(i).params(3), solutions(i).params(4), solutions(i).params(5), solutions(i).params(6));
    ...
    r_bp = solutions(i).params(3);
    sigma_bc = solutions(i).params(4);
    sigma_bp = solutions(i).params(6);
    A = 16.203;
    sigma_A = 0.772;
