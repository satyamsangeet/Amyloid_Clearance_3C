...
initial_guess = [0.8, 0.72, 0.2, 10, 7.2, 1, 0.2];

% Define bounds for parameters
lb = [0.7, 0.7, 0.1, 9, 7, 1, 0.1];
ub = [0.8, 0.8, 0.3, 11, 9, 2, 0.3];
...
lossID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v36_loss.csv', 'w');
if lossID == -1
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v36_output.csv', 'w');
