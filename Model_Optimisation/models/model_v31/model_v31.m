...
initial_guess = [0.35, 0.22, 0.2, 10, 7.2, 0.8, 0.2];

% Define bounds for parameters
lb = [0.1, 0.1, 0.1, 10, 7, 0, 0.1];
ub = [0.4, 0.3, 0.3, 11, 9, 1, 0.7];
...
lossID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v31_loss.csv', 'w');
if lossID == -1
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v31_output.csv', 'w');
