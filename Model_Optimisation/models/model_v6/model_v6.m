...
initial_guess = [0.1, 0.1, 0.3, 15, 6, 1];
...
options = optimoptions(@patternsearch,'MaxFunctionEvaluations',10,'MaxIterations',10);
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v9_output.csv', 'w');
