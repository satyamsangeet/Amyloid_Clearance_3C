...
options = optimoptions(@patternsearch,'MaxFunctionEvaluations',100,'MaxIterations',100);
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v15_output.csv', 'w');
