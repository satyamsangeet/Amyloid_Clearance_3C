...
initial_guess = [0.05, 0.05, 0.3, 15, 0.1, 0.2];

% Define bounds for parameters
lb = [0, 0, 0, 10, 0, 0];
ub = [0.1, 0.1, 0.5, 20, 5, 1];
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v3_output.csv', 'w');
