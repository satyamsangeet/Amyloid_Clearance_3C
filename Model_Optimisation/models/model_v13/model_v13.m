...
function total_error = objective_function(params, exp_csf, exp_plasma, loss_values)
    ...
    csf_last_36hours_data = sol(200000:236000, 1);
    plasma_last_36hours_data = sol(200000:236000, 2);
...
initial_guess = [0.1, 0.1, 0.25, 5, 1, 1];
...
options = optimoptions(@patternsearch,'MaxFunctionEvaluations',10000,'MaxIterations',10000);
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v13_output.csv', 'w');
