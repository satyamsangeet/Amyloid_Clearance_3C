...
function total_error = objective_function(params, exp_csf, exp_plasma)
    ...
    [t, sol] = ode45(@(t, y) model(t, y, a12_wake, a13_wake, a23_wake, A_wake, A_sleep, a, k), [0, 24*20], [0, exp_csf(1), exp_plasma(1)], opts);
    
    csf_last_36hours_data = sol(440000:476000, 2);
    plasma_last_36hours_data = sol(440000:476000, 3);
...
initial_guess = [0.35, 0.22, 0.15, 9, 7.2, 0.8, 0.2];

% Define bounds for parameters
lb = [0.1, 0.1, 0.1, 9, 7, 0, 0.1];
ub = [0.4, 0.3, 0.3, 10, 9, 1, 0.7];
...
lossID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v33_loss.csv', 'w');
if lossID == -1
...
fileID = fopen('/home/satyam/Documents/MATLAB/Two_Compartment_Model/Optimisation/model_v33_output.csv', 'w');
fprintf(fileID, 'Time,CSF,Plasma\n');
for hour = 0:0.001:480
    try
